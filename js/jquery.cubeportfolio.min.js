            ...
            e.each(r.find(s.options.lightboxDelegate), function(t, n) {
                ...
                if (e.inArray(r, a) === -1) {
                    ...
                    if (/youtube/i.test(r)) {
                        ...
                        i = "//player.vimeo.com/video/" + r.substring(r.lastIndexOf("http://birvacreativestudio.com/") + 1) + "?autoplay=1";
                        f = "isVimeo"
                    } else if (/ted\.com/i.test(r)) {
                        i = "http://embed.ted.com/talks/" + r.substring(r.lastIndexOf("http://birvacreativestudio.com/") + 1) + ".html";
                        f = "isTed"
